...
\SLOKA* \Ch{C}{Lidi} na \Ch{a}{lidi} jsou jako \Ch{d}{sa}n\Ch{G7}{ě, }\Ch{C}{člověk} na člo\Ch{a}{věka} jako\Ch{G7}{ kat} \NL
...
\Ch{G}{Klidně} \Ch{e}{seďme} \Ch{a}{na} ži\Ch{D7}{dli,} \Ch{G}{čtěme} bibli\Ch{G7}{ tam} to všechno je \NL
\Ch{C}{Samuelo}\Ch{a}{va} kniha nám \Ch{d}{poví}\Ch{G7}{dá,} \NL
\Ch{C}{jak} na Žida \Ch{a}{přišla} veli\Ch{d}{ká} bí\Ch{G7}{da,} \NL
...
Takhle \Ch{G7}{Goliáš} ho \Ch{Ab}{provokuje,} \Ch{D7}{David} slušně \Ch{G7}{salutuje} \NL
...
\Ch{C}{A jakej} by\Ch{D7}{ Go}\Ch{G7}{\ li}\Ch{C}{áš  } 
\end{TEXT}
